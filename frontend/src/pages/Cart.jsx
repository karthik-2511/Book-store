        ...
        {Cart && Cart.length === 0  && (
          <div className='h-screen'>
            <div className='h-[100%] flex items-center justify-center flex-col'>
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMKfSdKkSQ62VbPL8IUS0QDv4lZRv5UuKt6g&s" alt="" 
              className='lg:h-[50vh] mt-4 rounded-xl'/>
            </div>
          </div>
        )}
        {Cart && Cart.length > 0 && (
            ...
            {Cart.map((items,i)=>(
              ...
              key={i}>
                ...
                <div className='w-full md:m-auto'>
                  <h1 className='text-2xl text-zinc-100 font-semibold text-sstart mt-2 md:mt-0'>
                    {items.title}
                  </h1>
