  ...
  return (
    <>
        ...
        <div className={`${userDiv} top-0 left-0 h-screen w-full flex items-center justify-center`}>
            <div className='bg-zinc-700 rounded p-4 w-[80%] md:w-[50%] lg:w-[40%] text-white border border-white'>
                <div className='flex items-center justify-center'>
                    <h1 className='text-2xl font-semibold underline'>User Information</h1>
                    <button onClick={()=>setuserDiv("hidden")} className='ml-5'>
                        <RxCross1/>
                    </button>
                </div>
                <div className='mt-2'>
